...
exports.leaveParticipant = exports.joinParticipant = void 0;
...
const joinParticipant = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield associationsTS_1.UserActivityParticipation.create({
            userId,
            activityId,
        });
        res.status(200).json({
...
exports.joinParticipant = joinParticipant;
const leaveParticipant = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield associationsTS_1.UserActivityParticipation.destroy({
            where: {
                userId: userId,
...
exports.leaveParticipant = leaveParticipant;
