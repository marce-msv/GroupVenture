...
router.get('/profile/:id', auth_js_1.default, indexController_1.usersController.getUserInfo);
...
router.get('/:id', indexController_1.activityController.getActivityInfo);
